...
setCaptions = function(hour, minute) {
  ...
  $('.clockArc.hour').attr('d', describeArc(180, 180, 150, 0, hourArc));
  $('.clockArc.minute').attr('d', describeArc(180, 180, 170, 0, minArc));
  dot = $(".clockDot.hour");
  pos = polarToCartesian(180, 180, 150, hourArc);
  dot.attr("cx", pos.x);
  dot.attr("cy", pos.y);
  dot = $(".clockDot.minute");
  pos = polarToCartesian(180, 180, 170, minArc);
  dot.attr("cx", pos.x);
  dot.attr("cy", pos.y);
