...
polarToCartesian = function(centerX, centerY, radius, angleInDegrees) {
  var angleInRadians;
  angleInRadians = (angleInDegrees - 90) * Math.PI / 175.0;
  return {
...
describeArc = function(x, y, radius, startAngle, endAngle) {
  ...
  arcSweep = endAngle - startAngle <= 175 ? '0' : '1';
...
setCaptions = function() {
  ...
  $('.clockArc.hour').attr('d', describeArc(175, 175, 150, 0, hourArc));
  $('.clockArc.minute').attr('d', describeArc(175, 175, 170, 0, minArc));
  $('.clockDot.hour').attr('d', describeArc(175, 175, 150, hourArc - 3, hourArc));
  $('.clockDot.minute').attr('d', describeArc(175, 175, 170, minArc - 1, minArc));
  dot = $(".clockDot.hour");
  pos = polarToCartesian(175, 175, 150, hourArc);
  dot.attr("cx", pos.x);
  dot.attr("cy", pos.y);
  dot = $(".clockDot.minute");
  pos = polarToCartesian(175, 175, 170, minArc);
  dot.attr("cx", pos.x);
  dot.attr("cy", pos.y);
